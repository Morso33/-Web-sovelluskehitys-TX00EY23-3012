...
// a) Sort restaurants alphabetically by name
...
sorted.forEach((restaurant) => {
  ...
  // b) Highlight on click — exclusive (remove from previous, add to clicked)
  tr.addEventListener('click', () => {
    if (highlightedRow && highlightedRow !== tr) {
      highlightedRow.classList.remove('highlight');
    }
    tr.classList.add('highlight');
    highlightedRow = tr;

    // c) Show modal with full restaurant details
